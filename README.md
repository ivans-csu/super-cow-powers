...
**How to play:**
1. **Start the server:** Run `python server.py -p <port>`
2. **Connect clients:** Run `python client.py -i <server IP address> -p <port>` once for each client (each on their own terminal).
